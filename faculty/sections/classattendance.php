		...
		<div class="right-panel">
			...
			<div class="main-container-table">
				<table class="student-table">
					...
					$sql2 = "SELECT * FROM classes where Id = :cid";
					...
					if (!$stmt2) {
						...
						while (($row2 = oci_fetch_array($stmt2, OCI_ASSOC+OCI_RETURN_NULLS)) != false) {
							$date_array = date_parse_from_format("Y-m-d", $row2['CLASSDATE']);
							$formattedDate = date('M d', mktime($date_array['hour'], $date_array['minute'], $date_array['second'], $date_array['month'], $date_array['day'], $date_array['year']));
